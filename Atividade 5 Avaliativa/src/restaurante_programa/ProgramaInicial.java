...
public class ProgramaInicial {
	...
	public static void main(String[] args) {
		...
		try {
		FileWriter arquivoPedido =  new FileWriter("C:\\Users\\grazi\\OneDrive\\Documentos\\Sistemas de Informação\\2º Período\\Desenvolvimento de Software 1 - Geucimar\\1º Bimestre\\Aula 11 Dia 09.09.20\\arquivos-pedidos.txt", StandardCharsets.UTF_8);
